...
/* ------------------------------------------------------------------------
   ALLES DARUNTER IST AUSKOMMENTIERT (alter Shop-Inhalt, später wieder aktivierbar)
------------------------------------------------------------------------- */
/*
import { inter, INK } from "@/lib/ui";
...
// FESTER PREIS: €33,99 für alle Varianten
const BASE_PRICES: Record<Size, Record<Pages, number>> = {
  A5: { 100: 33.99, 140: 33.99, 200: 33.99 },
  A4: { 100: 33.99, 140: 33.99, 200: 33.99 },
};
...
export default function ShopPage_DEAKTIVIERT() {
              ...
              <div className="rounded-xl border p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted-foreground">SKU: PB</div>
