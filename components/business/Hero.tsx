      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          <motion.div variants={fade}>
            <h1 className={cx(display.className, "text-4xl sm:text-6xl leading-[1.05]")}>
              Powerbook <span className="text-white/80">Business</span>
            </h1>
            <p className="mt-5 max-w-2xl text-white/85 text-lg">
              Das fokussierte Notiz- & Arbeitsökosystem – mit eigenem{" "}
              <strong>Business-Dashboard</strong>, <strong>Branding & Domain</strong>, globaler{" "}
              <strong>Mitarbeiterverwaltung</strong>, <strong>Kontakten</strong>,{" "}
              <strong>Projekten</strong>, <strong>To-Dos</strong>, <strong>Kalender</strong> und mehr.
              Inklusive persönlichem Ansprechpartner.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Jetzt starten <ArrowRight className="h-4 w-4 transition group-hover:translate-x-0.5" />
              </Link>
              <Link
                href="#kontakt"
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-white/70">
              <span className="inline-flex items-center gap-2">
                <ShieldCheck className="h-4 w-4" /> DSGVO-ready
              </span>
              <span className="inline-flex items-center gap-2">
                <Server className="h-4 w-4" /> EU-Hosting
              </span>
              <span className="inline-flex items-center gap-2">
                <Lock className="h-4 w-4" /> SSO optional
              </span>
            </div>
          </motion.div>
          ...
          <motion.div variants={fade} className="relative hidden lg:block">
              ...
              <div className="rounded-2xl bg-white/90 p-4 shadow">
                ...
                <div className="mt-4 rounded-lg border">
                  <div className="grid grid-cols-4 gap-2 border-b p-3 text-xs text-gray-500">
                    <div>Projekt</div><div>Owner</div><div>Status</div><div>Fällig</div>
                  </div>
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="grid grid-cols-4 gap-2 p-3 text-xs">
            ...
            <div
              ...
              style={{ background: "radial-gradient(400px 200px at 60% 40%, rgba(255,255,255,.25), transparent)" }}
            />
          </motion.div>
        </motion.div>
      </div>
